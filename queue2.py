...
arrival_min = 1  # Mínimo para tempo de chegada (reduzido para aumentar a taxa de chegada)
arrival_max = 3  # Máximo para tempo de chegada
service_min = 2  # Mínimo para tempo de atendimento
service_max = 4  # Máximo para tempo de atendimento
...
servers = 2  # Número de servidores (2 para G/G/2/5)
